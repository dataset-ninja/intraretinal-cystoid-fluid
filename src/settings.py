...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/zeeshanahmed13/intraretinal-cystoid-fluid/download?datasetVersionNumber=3"
...
ORGANIZATION_NAME: Optional[Union[str, List[str]]] = [
    "Mehran University of Engineering and Technology (MUET), Pakistan",
    "Liaquat University of Medical and Health Sciences (LUMHS), Pakistan",
]
